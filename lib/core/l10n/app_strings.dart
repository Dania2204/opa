...
abstract class S {
  ...
  static String _t(String es, String en) => isSpanish ? es : en;

  // ── App ───────────────────────────────────────────────────────────────────
  static String get appName => 'PAEGo';
  static String get appTagline => _t('Programa de Alimentación Escolar', 'School Feeding Programme');
  ...
  static String get loginSubtitle => _t('Inicia sesión para continuar', 'Sign in to continue');
  ...
  static String get loginForgot => _t('¿Olvidaste tu contraseña?', 'Forgot password?');
  static String get loginRequired => _t('Este campo es obligatorio', 'This field is required');
  static String get loginInvalidEmail => _t('Ingresa un correo válido', 'Enter a valid email');
  static String get loginInvalidCredentials => _t('Usuario o contraseña inválidos', 'Invalid email or password');
  static String get loginRegistrationDisabled =>
      _t('El registro solo lo puede hacer un administrador.', 'User registration is handled only by an administrator.');

  // ── Register ──────────────────────────────────────────────────────────────
  static String get registerTitle => _t('Crear cuenta', 'Create account');
  static String get registerSubtitle => _t('Únete a la red PAEGo', 'Join the PAEGo network');
  ...
  static String get registerConfirmPassword => _t('Confirmar contraseña', 'Confirm password');
  static String get registerRole => _t('Rol', 'Role');
  static String get registerIdNumber => _t('Número de identificación', 'ID number');
  static String get registerInstitution => _t('Institución (opcional)', 'Institution (optional)');
  static String get registerButton => _t('Crear cuenta', 'Create account');
  static String get registerHaveAccount => _t('¿Ya tienes cuenta?', 'Already have an account?');
  static String get registerSignIn => _t('Iniciar sesión', 'Sign in');
  static String get registerPasswordMismatch => _t('Las contraseñas no coinciden', 'Passwords do not match');
  static String get registerSuccess => _t('Cuenta creada exitosamente', 'Account created successfully');
  static String get registerPhotoUpload => _t('Subir foto', 'Upload photo');
  static String get registerDisabledTitle => _t('Registro deshabilitado', 'Registration disabled');
  static String get registerDisabledMessage =>
      _t('Solo un administrador puede crear cuentas.', 'Only an administrator can create user accounts.');
  static String get registerBackToLogin => _t('Volver al inicio de sesión', 'Back to sign in');

  // ── Roles ─────────────────────────────────────────────────────────────────
  static String get roleSuperAdmin => 'Super Admin';
  static String get roleAdmin => 'Admin';
  static String get roleRector => _t('Rector', 'Rector');
  static String get roleDriver => _t('Conductor', 'Driver');

  static String get roleDescSuperAdmin => _t('Acceso total — ver y gestionar todo.', 'Full system access — view and manage everything.');
  static String get roleDescAdmin => _t('Gestiona entregas y conductores en tu municipio.', 'Manage deliveries and drivers in your municipality.');
  static String get roleDescRector => _t('Rastrea entregas a tu escuela y envía informes.', 'Track deliveries to your school and submit reports.');
  static String get roleDescDriver => _t('Acepta órdenes y navega rutas de entrega.', 'Accept orders and navigate delivery routes.');

  // ── Home / Dashboard ──────────────────────────────────────────────────────
  static String get dashboardWelcome => _t('Buenos días', 'Good morning');
  static String get dashboardActiveDeliveries => _t('Entregas activas', 'Active deliveries');
  static String get dashboardPendingOrders => _t('Pedidos pendientes', 'Pending orders');
  static String get dashboardDriversOnline => _t('Conductores activos', 'Drivers online');
  static String get dashboardReportsToday => _t('Informes hoy', 'Reports today');
  static String get dashboardQuickActions => _t('Acciones rápidas', 'Quick actions');
  static String get dashboardRecentActivity => _t('Actividad reciente', 'Recent activity');
  ...
  static String get mapSubtitle => _t('Seguimiento en tiempo real', 'Real-time tracking');
  static String get mapMyLocation => _t('Mi ubicación actual', 'My current location');
  static String get mapAddSchool => _t('Agregar escuela', 'Add school location');
  ...
  static String get mapSelectOnMap => _t('Toca el mapa para colocar el pin', 'Tap on the map to place pin');
  static String get mapNoVehicles => _t('Sin vehículos rastreados', 'No vehicles currently tracked');
  static String get mapStartRoute => _t('Iniciar ruta', 'Start route');
  static String get mapStopRoute => _t('Detener ruta', 'Stop route');
  static String get mapSendLocation => _t('Enviando ubicación…', 'Sending location…');
  static String get mapVehiclesActive => _t('vehículos activos', 'vehicles active');

  // ── Deliveries / Orders ───────────────────────────────────────────────────
  static String get orderTitle => _t('Pedidos', 'Orders');
  static String get orderAvailable => _t('Pedidos disponibles', 'Available orders');
  ...
  static String get orderCompleteButton => _t('Marcar entregado', 'Mark delivered');
  static String get orderNoOrders => _t('Sin pedidos disponibles', 'No orders available');
  ...
  // ── Reports ───────────────────────────────────────────────────────────────
  static String get reportTitle => _t('Informes de entrega', 'Delivery Reports');
  static String get reportNew => _t('Nuevo informe', 'New report');
  static String get reportCondition => _t('Estado de los alimentos', 'Food condition');
  ...
  static String get reportSubmitted => _t('Informe enviado', 'Report submitted');
  static String get reportPendingSync => _t('Sincronización pendiente', 'Pending sync');
  ...
  static String get personnelEmpty => _t('Sin personal registrado aún', 'No personnel registered yet');
  static String get personnelDelete => _t('Eliminar personal', 'Remove personnel');
  static String get personnelDeleteConfirm => _t('¿Eliminar esta persona del sistema?', 'Remove this person from the system?');
  static String get personnelEdit => _t('Editar', 'Edit');
  static String get personnelAdminOnly =>
      _t('Solo los administradores pueden crear o eliminar usuarios.', 'Only administrators can create or remove users.');
  static String get personnelCreated => _t('Usuario creado exitosamente', 'User created successfully');
  static String get personnelCannotDeleteSelf =>
      _t('No puedes eliminar tu propia cuenta', 'You cannot remove your own account');

  // ── Messages ──────────────────────────────────────────────────────────────
  static String get messagesTitle => _t('Mensajes', 'Messages');
  static String get messagesTypeHere => _t('Escribe un mensaje…', 'Type a message…');
  ...
  static String get profileLogoutConfirm => _t('¿Seguro que quieres cerrar sesión?', 'Are you sure you want to log out?');
  static String get profilePrivacy => _t('Privacidad', 'Privacy');
  static String get profileNotifications => _t('Notificaciones', 'Notifications');
  ...
  static String get settingsSyncDone => _t('Datos sincronizados', 'All data synced');

  // ── Connectivity ──────────────────────────────────────────────────────────
  static String get syncOffline => _t('Sin conexión — cambios guardados localmente', 'Offline — changes saved locally');
  static String get syncOnline => _t('Conectado — sincronizando datos', 'Back online — syncing data');
  ...
  static String get pageNotFound => _t('Página no encontrada', 'Page not found');
  static String get routeNotFound => _t('Esta ruta no existe.', 'This route does not exist.');
